...
public class LinkmanFriendAdapter extends BaseExpandableListAdapter {
    private List<bean1.ResultBean> list;
    private Context mContext;

    public LinkmanFriendAdapter(List<bean1.ResultBean> list, FragmentActivity activity) {
        this.list = list;
        mContext = activity;
    }
...
*/
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        bean2.ResultBean contentInfo = list.get(groupPosition).getInfo().get(childPosition);
