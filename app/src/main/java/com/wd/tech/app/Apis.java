...
//
    ...
    //用户收藏列表
    public static final String FINDALLINFOCOLLECTION = "user/verify/v1/findAllInfoCollection";
    //添加收藏
    public static final String ADDCOLLECTION = "user/verify/v1/addCollection";
    //取消收藏（支持批量操作）
    public static final String CANCELCOLLECTION = "user/verify/v1/cancelCollection";
    //用户关注列表
    ...
    //取消关注
    public static final String CANCELFOLLOW = "user/verify/v1/cancelFollow";
    //校验手机号是否可用
    ...
    //根据手机号查询用户信息
    public static final String FINDUSERBYPHONE = "user/verify/v1/findUserByPhone?phone=";
    //解绑faceId
    ...
    public static final String ADDFRIEND2 = "chat/verify/v1/addFriend";
    //删除好友
    ...
    //资讯推荐展示列表(包含单独板块列表展示)
    public static final String INFORECOMMENDLIST = "information/v1/infoRecommendList";
    //资讯详情展示
    public static final String FINDINFORMATIONDETAILS = "information/v1/findInformationDetails";
    //所有板块查询
    public static final String FINDALLINFOPLATE = "information/v1/findAllInfoPlate";
    //修改资讯分享数
    ...
    //取消点赞
    public static final String CANCELGREAT = "information/verify/v1/cancelGreat";
    //资讯用户评论
    public static final String ADDINFOCOMMENT = "information/verify/v1/addInfoComment";
    //查询资讯评论列表
    public static final String FINDALLINFOCOMMENTLIST = "information/v1/findAllInfoCommentList";
    //根据标题模糊查询
    public static final String FINDINFORMATIONBYTIRLE = "information/v1/findInformationByTitle";
    //根据作者名模糊查询
    ...
    //社区用户评论列表（bean方式返参）
    public static final String FINDCOMMUNITYUSERCOMMENTLIST ="community/v1/findCommunityUserCommentList?communityId=%s&page=1&count=5";
    //社区评论
    ...
    // 查询用户发布的帖子
    public static final String FINDUSERPOSTBYID = "community/verify/v1/findUserPostById";
